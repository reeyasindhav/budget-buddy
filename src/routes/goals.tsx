...
export const Route = createFileRoute("/goals")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track savings goals with progress rings, target dates and one-tap contributions." },
      { property: "og:title", content: "Savings goals — Budgetly" },
      { property: "og:description", content: "Set targets and watch your savings progress in real time." },
    ],
  }),
  component: Goals,
});
  ...
  return (
    <AppShell title="Savings goals">
      <div className="animate-fade-up flex flex-wrap items-end justify-between gap-5">
        ...
        <button
          onClick={() => toast("Goal builder coming in Plus")}
